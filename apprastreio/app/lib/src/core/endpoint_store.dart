...
class EndpointStore {
  static const String _kList = 'endpoints_v2_tracking';
  static const String _kActive = 'active_endpoint_id_tracking';
  static const String builtInId = 'builtin_saveincloud';

  // Porta fixa — o utilizador nunca mexe nisto.
  static const int localPort = 8092;

  /// Constrói URL a partir de um IP simples: "192.168.1.5" → "http://192.168.1.5:8092"
  ...
  static const SavedEndpoint builtIn = SavedEndpoint(
    ...
    url: 'https://holdfy-dev.sp1.br.saveincloud.net.br/svc/tracking',
    builtIn: true,
  );
