...
use super::service::{TokenServiceService, ServiceError};

#[derive(Clone)]
pub struct AppState {
    pub service: Arc<dyn TokenServiceService>,
}
...
pub fn routes(service: Arc<dyn TokenServiceService>) -> Router {
    Router::new()
...
) -> Result<Json<ItemsPage<Vec<TokenService>>>, AppError> {
