...
use super::service::{AccountRulesService, ServiceError};

#[derive(Clone)]
pub struct AppState {
    pub service: Arc<dyn AccountRulesService>,
}
...
pub fn routes(service: Arc<dyn AccountRulesService>) -> Router {
    Router::new()
...
) -> Result<Json<ItemsPage<Vec<AccountRules>>>, AppError> {
