...
use super::service::{ControlMedService, ServiceError};

#[derive(Clone)]
pub struct AppState {
    pub service: Arc<dyn ControlMedService>,
}
...
pub fn routes(service: Arc<dyn ControlMedService>) -> Router {
    Router::new()
...
) -> Result<Json<ItemsPage<Vec<ControlMed>>>, AppError> {
