...
use super::service::{TransactionService, ServiceError};

#[derive(Clone)]
pub struct AppState {
    pub service: Arc<dyn TransactionService>,
}
...
pub fn routes(service: Arc<dyn TransactionService>) -> Router {
    Router::new()
...
) -> Result<Json<ItemsPage<Vec<Transaction>>>, AppError> {
