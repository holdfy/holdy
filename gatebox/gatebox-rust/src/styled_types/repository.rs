...
#[async_trait]
pub trait StyledTypesRepository: Send + Sync {
    async fn list(&self, offset: i64, limit: i64) -> Result<ItemsPage<Vec<StyledTypes>>, RepositoryError>;
    async fn get_by_id(&self, id: i64) -> Result<Option<StyledTypes>, RepositoryError>;
    async fn insert(&self, item: &StyledTypes) -> Result<i64, RepositoryError>;
    async fn update(&self, id: i64, item: &StyledTypes) -> Result<(), RepositoryError>;
    async fn delete(&self, id: i64) -> Result<bool, RepositoryError>;
}

pub struct StyledTypesRepositoryImpl {
    read: Arc<PgPool>,
    write: Arc<PgPool>,
}

impl StyledTypesRepositoryImpl {
