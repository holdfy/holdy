...
#[async_trait]
pub trait KycRiskTypesRepository: Send + Sync {
    async fn list(&self, offset: i64, limit: i64) -> Result<ItemsPage<Vec<KycRiskTypes>>, RepositoryError>;
    async fn get_by_id(&self, id: i64) -> Result<Option<KycRiskTypes>, RepositoryError>;
    async fn insert(&self, item: &KycRiskTypes) -> Result<i64, RepositoryError>;
    async fn update(&self, id: i64, item: &KycRiskTypes) -> Result<(), RepositoryError>;
    async fn delete(&self, id: i64) -> Result<bool, RepositoryError>;
}

pub struct KycRiskTypesRepositoryImpl {
    read: Arc<PgPool>,
    write: Arc<PgPool>,
}

impl KycRiskTypesRepositoryImpl {
