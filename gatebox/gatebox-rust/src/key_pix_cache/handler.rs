...
use super::service::{KeyPixCacheService, ServiceError};

#[derive(Clone)]
pub struct AppState {
    pub service: Arc<dyn KeyPixCacheService>,
}
...
pub fn routes(service: Arc<dyn KeyPixCacheService>) -> Router {
    Router::new()
...
) -> Result<Json<ItemsPage<Vec<KeyPixCache>>>, AppError> {
