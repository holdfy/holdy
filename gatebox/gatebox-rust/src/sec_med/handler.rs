...
use super::service::{SecMedService, ServiceError};

#[derive(Clone)]
pub struct AppState {
    pub service: Arc<dyn SecMedService>,
}
...
pub fn routes(service: Arc<dyn SecMedService>) -> Router {
    Router::new()
...
) -> Result<Json<ItemsPage<Vec<SecMed>>>, AppError> {
