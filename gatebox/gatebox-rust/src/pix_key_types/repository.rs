...
#[async_trait]
pub trait PixKeyTypesRepository: Send + Sync {
    async fn list(&self, offset: i64, limit: i64) -> Result<ItemsPage<Vec<PixKeyTypes>>, RepositoryError>;
    async fn get_by_id(&self, id: i64) -> Result<Option<PixKeyTypes>, RepositoryError>;
    async fn insert(&self, item: &PixKeyTypes) -> Result<i64, RepositoryError>;
    async fn update(&self, id: i64, item: &PixKeyTypes) -> Result<(), RepositoryError>;
    async fn delete(&self, id: i64) -> Result<bool, RepositoryError>;
}

pub struct PixKeyTypesRepositoryImpl {
    read: Arc<PgPool>,
    write: Arc<PgPool>,
}

impl PixKeyTypesRepositoryImpl {
