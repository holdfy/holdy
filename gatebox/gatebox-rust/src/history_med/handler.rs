...
use super::service::{HistoryMedService, ServiceError};

#[derive(Clone)]
pub struct AppState {
    pub service: Arc<dyn HistoryMedService>,
}
...
pub fn routes(service: Arc<dyn HistoryMedService>) -> Router {
    Router::new()
...
) -> Result<Json<ItemsPage<Vec<HistoryMed>>>, AppError> {
