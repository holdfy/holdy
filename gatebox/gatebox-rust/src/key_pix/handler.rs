...
use super::service::{KeyPixService, ServiceError};

#[derive(Clone)]
pub struct AppState {
    pub service: Arc<dyn KeyPixService>,
}
...
pub fn routes(service: Arc<dyn KeyPixService>) -> Router {
    Router::new()
...
) -> Result<Json<ItemsPage<Vec<KeyPix>>>, AppError> {
