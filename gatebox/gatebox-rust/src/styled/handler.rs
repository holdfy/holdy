...
use super::service::{ServiceError, StyledService};

#[derive(Clone)]
pub struct AppState {
    pub service: Arc<dyn StyledService>,
}
...
pub fn routes(service: Arc<dyn StyledService>) -> Router {
    Router::new()
...
) -> Result<Json<ItemsPage<Vec<Styled>>>, AppError> {
