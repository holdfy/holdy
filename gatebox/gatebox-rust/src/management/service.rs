...
use super::repository::{ManagementRepository, RepositoryError};
...
pub trait ManagementService: Send + Sync {
    async fn list(&self, offset: i64, limit: i64) -> Result<ItemsPage<Vec<Management>>, ServiceError>;
    async fn get_by_id(&self, id: i64) -> Result<Option<Management>, ServiceError>;
    async fn create(&self, item: &Management) -> Result<i64, ServiceError>;
    async fn update(&self, id: i64, item: &Management) -> Result<(), ServiceError>;
    async fn delete(&self, id: i64) -> Result<bool, ServiceError>;
}

pub struct ManagementServiceImpl { repo: Arc<dyn ManagementRepository> }
impl ManagementServiceImpl {
    pub fn new(repo: Arc<dyn ManagementRepository>) -> Self { Self { repo } }
}
