-- Standalone DDL for transaction_anchors (same as migrations/20260531000000_transaction_anchors.sql).
-- Apply: psql -U postgres -d dubai-cash -f anchor-blockchain-schema.sql
