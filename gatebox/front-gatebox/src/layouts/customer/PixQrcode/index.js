...
export default function CustomerPixQrcode() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await customersApi.pix.qrcode(body);
      setResult(res);
    } catch (err) {
  ...
  return (
    <DashboardLayout>
      <DashboardNavbar />
      <MDBox py={3}>
        <MDTypography variant="h4" fontWeight="medium" mb={3}>Gerar QR Code PIX</MDTypography>
