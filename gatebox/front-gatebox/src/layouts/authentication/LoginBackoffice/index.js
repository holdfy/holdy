/**
 * Login Backoffice - Acesso ao painel de operações
 */
...
export default function LoginBackoffice() {
  ...
  const from = location.state?.from?.pathname || "/backoffice/logs";
  ...
  return (
    <GateboxAuthLayout>
      <Card>
        <MDBox variant="gradient" bgColor="secondary" borderRadius="lg" mx={2} mt={2} p={2} mb={1} textAlign="center">
        ...
        <MDBox pt={4} pb={3} px={3}>
          <MDBox component="form" role="form" onSubmit={handleSubmit}>
            ...
            <MDBox mt={4} mb={1}>
              <MDButton variant="gradient" color="secondary" fullWidth type="submit" disabled={loading}>
                {loading ? "Entrando..." : "Entrar"}
              </MDButton>
            </MDBox>
            <MDBox mt={3} mb={1} textAlign="center">
              <MDTypography variant="caption" color="text">
                <Link to="/customer/login" style={{ color: "inherit" }}>Cliente</Link>
                {" · "}
