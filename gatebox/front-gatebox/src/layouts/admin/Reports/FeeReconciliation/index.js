/**
 * Conciliação de taxas (TTO, TPO) - valor cobrado por transação
 */
...
export default function ReportFeeReconciliation() {
    ...
    <DashboardLayout>
      ...
      <MDBox py={3}>
        ...
        <MDTypography variant="body2" color="text" mb={2}>
          Taxas TTO/TPO cobradas por transação. O campo amount representa o valor da taxa.
        </MDTypography>
        {loading ? (
            ...
            <MDBox mb={3} display="flex" gap={2} flexWrap="wrap">
              ...
              <Card sx={{ p: 2, minWidth: 180 }}>
                ...
                <MDTypography variant="h5" color="dark">
                  {formatCurrency(totals.tto + totals.tpo)}
                </MDTypography>
              </Card>
            </MDBox>
                ...
                <Table size="small">
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align="right">Valor cobrado</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {items.map((row, i) => (
                      <TableRow key={row.id || i}>
                        ...
                        <TableCell>
                          {SUB_TYPE_LABELS[row.sub_type_transaction_id] ?? row.sub_type_transaction_id}
                        </TableCell>
                        <TableCell>{row.account_id}</TableCell>
                        <TableCell>{row.description || row.remittance_information || "-"}</TableCell>
